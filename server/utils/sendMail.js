...
html: `
  <div style="font-family:Arial,sans-serif; background-color:#f9f9f9; padding:30px; border-radius:10px; max-width:600px; margin:auto; border:1px solid #ddd;">
    ...
    <div style="text-align:center; margin:30px 0;">
      <a href="https://moodify-ashy-chi.vercel.app/login" style="background-color:#6a5acd; color:#fff; text-decoration:none; padding:12px 24px; border-radius:30px; font-weight:bold; font-size:16px;">
        Go to My Account
      </a>
    </div>
